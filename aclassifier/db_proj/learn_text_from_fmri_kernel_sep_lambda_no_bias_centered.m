...
function [weightMatrix, r] = learn_text_from_fmri_kernel_sep_lambda_no_bias_centered(trainingData, trainingTargets, fCrossValidate)
...
%trainingTargets = zscore(trainingTargets);
