...
function [weightMatrix, minerr] = learn_text_from_fmri_kernel(trainingData, trainingTargets, fCrossValidate)
...
if (fCrossValidate==1)
    ...
    [minerr, minerrIndex] = min(CVavgerr);
    regularizationParam = regParams(minerrIndex);
