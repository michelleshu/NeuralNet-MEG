function [experiment] = GNBTest(experiment)
numExamples = size(experiment.testExamples,1);
numFeatures = size(experiment.testExamples,2); 
...
testresult.numCorrect = length(find((testresult.trueLabels - testresult.classifierLabels) == 0));
