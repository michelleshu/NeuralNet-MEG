function [ests, ranks, preds, pove] = doOneCrossValNoZYesBias(cur_data, sem_matrix, folds, numFolds, numWords, save_file,zscore_folds)
...
%         sem_matrix(folds~=i,:),1);
    ...
    for cur_word = 1:size(testBrainExample,1),
        ...
        d = pdist([targetEstimate; cur_sem_all], 'cosine');
